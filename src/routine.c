...
/*   Updated: 2024/11/24 22:29:41 by lumiguel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int philo_sleeps(t_philo *philo)
{
	...
	if (philo->dead == 1 || philo->superv->dead_flag == 1 || (timestamps() - philo->last_meal > philo->time_to_die))
	{
		print(philo,"died");
